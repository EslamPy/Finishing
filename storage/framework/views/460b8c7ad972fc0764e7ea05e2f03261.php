                                    ...
                                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="table-body-row">
                                            ...
                                            <td class="product-remove">
                                                <a href="#" onclick="removeProduct(<?php echo e($item['id']); ?>)"><i class="far fa-window-close"></i></a>
                                            </td>
                                            <!-- Delete a Product From the Cart -->
                                            ...
                                            <td class="product-quantity">
                                                <input type="number" value="<?php echo e($item['quantity']); ?>" placeholder="1" class="quantityInput" data-price="<?php echo e($item['price']); ?>" data-item-id="<?php echo e($item['id']); ?>" min="1">
                                            </td>
