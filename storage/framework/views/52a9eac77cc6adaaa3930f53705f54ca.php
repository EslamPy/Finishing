            ...
            <div class="row">
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="<?php echo e(asset('assets/img/Project-images/Ram/Ram.jpg')); ?>" alt="IMG-BENNER"
                            style="width: 100%;max-width: 100%;height: auto;margin-left: 5px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="<?php echo e(route('shop', ['category' => 'RAM'])); ?>"
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="<?php echo e(asset('assets/img/Project-images/Motherboard/Motherboard.png')); ?>" alt="IMG-BENNER"
                            style="width: 100%;max-width: 100%;height: auto;margin-left: 2px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="<?php echo e(route('shop', ['category' => 'Motherboard'])); ?>"
                                class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                Motherboard
                            </a>
                        </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="<?php echo e(asset('assets/img/Project-images/Power Supply/Powersupply.png')); ?>" alt="IMG-BENNER"
                            style="width: 100%;max-width: 100%;height: auto;margin-left: -9px; margin-top: 51px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="<?php echo e(route('shop', ['category' => 'PowerSupply'])); ?>"
                                class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                Power Supply
                            </a>
                        </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="<?php echo e(asset('assets/img/Project-images/CPU/CPU.jpg')); ?>" alt="IMG-BANNER"
                            style="width: 100%; max-width: 100%; height: auto; margin-left: -1px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="<?php echo e(route('shop', ['category' => 'CPU'])); ?>"
                                class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                CPU
                            </a>
                        </div>
                            ...
                            <div class="properties-card">
                                <div class="properties-img">
                                    ...
                                    <div class="socal_icon">
                                        ...
                                        <a href="<?php echo e(route('products', ['id' => $item->id])); ?>"><i
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-6">
                        <div class="image">
                            ...
                            <img src="<?php echo e(asset('assets/img/Project-images/Case/Pc Gaming.png')); ?>" alt=""
                    ...
                    <div class="content-column col-lg-6">
                        ...
                        <div class="text" style="display: block !important;">Discover our 30% Off Deal of the Month on
                            LianLi PC cases! Elevate your setup
                        ...
                        <a href="<?php echo e(route('cart')); ?>" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Add to
                            Cart</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                ...
                                <p class="excerpt">Gamers faced a severe shortage of graphics cards due to high demand,
                                    ...
                                    availability.</p>
                                <a href="<?php echo e(route('news')); ?>" class="read-more-btn">read more <i
                    ...
                    <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                <h3><a href="<?php echo e(route('news')); ?>">Good thoughts bear good fresh juicy fruit.</a></h3>
                                <p class="blog-meta">
                                    <span class="author"><i class="fas fa-user"></i> Admin</span>
